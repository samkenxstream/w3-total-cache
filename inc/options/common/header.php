...
<?php
	...
	// Maybe show the "hosting survey" atop the page.
	if ( \W3TC\Generic_User_Notice_Utility::maybe_show_hosting_survey() ) {
		echo \W3TC\Generic_User_Notice_Utility::get_esc_hosting_survey();
	}
